...
<div class="row">
	...
	<div class="six columns text-right">
		<div class="medium primary btn">
			<a onClick="location.href='{{ route('cerberus.groups.create') }}'">New Group</a>
		</div>
	</div>
</div>
<div class="row">
  	<div class="twelve columns">
		<table class="rounded striped">
			...
			@foreach ($groups as $group)
				<tr>
					<td><a href="{{ route('cerberus.groups.show', $group->hash) }}"></td>
					<td>
						<?php
					...
					<td>
						<div class="medium info btn">
							<a onClick="location.href='{{ route('cerberus.groups.edit', [$group->hash]) }}'">Edit</a>
						</div>
					 	<div class="medium info btn">
					 		<a class="action_confirm {{ $group->name == 'Admins' ? 'disabled' : '' }}"  data-token="{{ csrf_token() }}" data-method="delete" href="{{ route('cerberus.groups.destroy', [$group->hash]) }}">Delete</a>
					 	</div>
					 </td>
				</tr>
			@endforeach
