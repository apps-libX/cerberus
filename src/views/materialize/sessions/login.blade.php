...
<div class="row">
    <div class="col l6 offset-l3 m8 offset-m2 s12">
        <form method="POST" action="{{ route('cerberus.session.store') }}" accept-charset="UTF-8">
            ...
            <p>
                ...
                <a href="{{ route('cerberus.forgot.form') }}" class="btn waves-effect waves-light red lighten-2">Forgot Password</a>
            </p>
